...
const COMMAND_ROUTES = Object.freeze({
  ...
  'share-debug-profile': commandRoute({id: 'share-debug-profile', method: 'POST', path: '/api/share/debug-profile', contractClass: 'pending'}),
  ...
  'share-create': commandRoute({id: 'share-create', method: 'POST', path: '/api/share', contractClass: 'pending'}),
  'share-stop-token': commandRoute({id: 'share-stop-token', method: 'POST', path: '/api/share/stop', contractClass: 'pending'}),
  'share-stop-active': commandRoute({id: 'share-stop-active', method: 'POST', path: '/api/share/stop', contractClass: 'pending'}),
  'share-extend': commandRoute({id: 'share-extend', method: 'POST', path: '/api/share/extend', contractClass: 'pending'}),
