...
- [ ] DECISION/SPIKE: CodeMirror 6 (MIT/free) vs extend the textarea — full 2-path plan, success gate, and the concrete "remove the textarea editor layer" list in `EDITOR-CODEMIRROR.md`. CM would close #6 + most of the editor-options list above. Promote to a DOIT once the direction is approved.
