# DOIT.p2.multi-server-common-service-decision.md - Decide Whether Multi-Server Common Services Are Justified
...
- Measure only after `DOIT.p1.backend-lifetime-supervision.md` has frozen the private-root/caller-shared-root topology; otherwise duplicated or orphaned processes corrupt the denominator.
