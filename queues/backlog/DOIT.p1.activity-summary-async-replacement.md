# DOIT.p1.activity-summary-async-replacement.md - Replace Summary With A Retained Asynchronous Product

Source provenance: `DOIT.p1.md` P1-A and the former `DOIT.p1.activity-summary-async-replacement.md`.
