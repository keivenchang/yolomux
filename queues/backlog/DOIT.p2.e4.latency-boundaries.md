# DOIT.p2.e4.latency-boundaries.md - Attribute Common Multi-Second Delays Correctly

Source provenance: `DOIT.p2.md` P2-C and the former `DOIT.p2.e4.latency-boundaries.md`.
