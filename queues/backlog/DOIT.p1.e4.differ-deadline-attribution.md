# DOIT.p1.e4.differ-deadline-attribution.md - Preserve Differ Data And Reject False Changes
...
- One integrator owns the final Differ payload contract and composed browser fixture. Filesystem descriptor authorization remains in `DOIT.p0.e5.filesystem-descriptor-authorization.md`; generic timing instrumentation remains in `DOIT.p2.e4.latency-boundaries.md`.
