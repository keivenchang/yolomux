...
SETTING_COMMENTS: dict[tuple[str, str], str] = {
    ...
    ("performance", "agent_window_cooldown_seconds"): "Seconds, 0-300. How long a Claude/Codex window that just stopped working keeps the yellow cooldown dot. 0 disables the cooldown dot.",
...
SETTING_GUI_SECTIONS: dict[tuple[str, str], str] = {
    ...
    ("performance", "agent_window_cooldown_seconds"): "Performance",
