...
SETTING_CHOICES: dict[tuple[str, str], set[str]] = {
    ...
    ("general", "language"): {"system", "en", "zh-Hant", "zh-Hans", "es", "ja", "de", "fr", "en-XA"},
...
SETTING_COMMENTS: dict[tuple[str, str], str] = {
    ...
    ("general", "language"): "UI language. system matches the browser/OS; otherwise a locale code with a shipped catalog (en, zh-Hant, zh-Hans, es, ja, de, fr, en-XA pseudo). More locales arrive in later i18n phases.",
    ...
    ("appearance", "terminal_theme"): "dark | light | follow-app. Terminal color theme. Defaults to follow-app (matches the global app theme); a light terminal raises xterm minimumContrastRatio so dark-tuned agent output stays legible.",
