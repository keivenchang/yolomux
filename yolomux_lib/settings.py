...
SETTING_COMMENTS: dict[tuple[str, str], str] = {
    ...
    ("performance", "agent_window_cooldown_seconds"): "Seconds, 0-300. Yellow means the agent is done; look at its output. This controls how long a Claude/Codex tmux sub-window keeps the yellow finished ball. 0 disables the finished ball.",
