...
SETTING_COMMENTS: dict[tuple[str, str], str] = {
    ...
    ("performance", "settings_refresh_ms"): "Milliseconds, 1000-60000. Refreshes Preferences/settings state so changes made by another YOLOmux client are picked up.",
    ("performance", "activity_summary_refresh_ms"): "Milliseconds, 10000-600000. Minimum interval for hidden YO!agent activity-summary refreshes; visible YO!agent and manual refresh can refresh immediately.",
    ("performance", "server_event_poll_ms"): "Milliseconds, 1000-60000. Server-side fallback poll interval for filesystem/transcript/settings changes that are pushed to browser clients.",
    ...
    ("file_explorer", "session_files_refresh_seconds"): "Seconds, 1-60. Refreshes the changed-files/Differ payload from /api/session-files. The server serves cached results immediately and refreshes stale payloads in the background on this cadence.",
