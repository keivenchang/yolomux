...
SETTING_COMMENTS: dict[tuple[str, str], str] = {
    ...
    ("appearance", "editor_color_scheme"): "Editor color scheme. Built-ins include dark, One Dark, Dracula, Monokai, VS Code Dark+, Nord, GitHub Light, VS Code Light+, One Light, and Solarized Light.",
