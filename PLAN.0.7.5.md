...
- [ ] The archived 0.7.4 closure SHA passes one unmodified `python3 tools/check.py` and is committed with the final evidence.
- [x] Restarted 7771 passed authenticated real-browser acceptance on the committed 0.7.4 candidate `7a1d558e1` as PID 4189697 with served bundle `d784f475`; `/tmp/yolomux-074-manual-7a1d558e1-r22.json` is the clean mode-0600 artifact.
