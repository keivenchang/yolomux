...
| --- | --- |
| Browser → YOLOmux | HTTPS API/SSE and RFC 6455 WebSocket on the configured listener—`:7770` in the standard Linux launch, `:8000` in the standard macOS launch, or the port passed to `yolomux.py` (the setup example uses `:9998`). |
