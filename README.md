...
- The language picker in the top bar, login/setup screens, and Preferences supports English, Simplified and Traditional Chinese, Japanese, Spanish, French, Arabic, German, Russian, Hindi, Korean, Vietnamese, Thai, Turkish, Hebrew, Brazilian Portuguese, Dutch, Polish, and Italian. The topbar picker stays open while background session refreshes run.
