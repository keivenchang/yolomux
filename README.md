...
- **Localization.** The UI is translated into a dozen languages — English, Traditional and Simplified Chinese, Spanish, Japanese, German, French, Brazilian Portuguese, Russian, Korean, Hindi, and Arabic — plus an `en-XA` pseudo-locale for translation QA. A language switcher in the top bar and on the login screen persists the choice to `general.language`, and right-to-left locales (Arabic, Hebrew) mirror the whole layout.
