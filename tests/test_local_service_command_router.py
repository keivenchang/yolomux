...
@pytest.mark.parametrize(("router", "actions"), (
    ...
    (statusd.STATUSD_COMMAND_ROUTER, {"ping", "status", "profile", "snapshot", "inventory", "activity_summary", "wait_generation", "invalidate", "lease", "release", "shutdown", "shutdown_if_idle"}),
    (jobd.JOBD_COMMAND_ROUTER, set(jobd.JOBD_REQUEST_ACTIONS)),
