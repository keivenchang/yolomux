...
| --- | --- | --- | --- | --- |
| 0.7.4 | `v0.7.4` | tagged release commit | [v0.7.4-evidence.md](v0.7.4-evidence.md) | behavior-preserving architecture cleanup, fully gated and accepted on 7771 |
...
Verified 2026-08-12 against `git tag -l` and `git log --grep="^release: v0.7"` in `yolomux.dev7771`.
