...
Verified 2026-08-15 against the local signature-bearing annotated tag objects, `origin/main`, and the direct and peeled origin tag refs in `yolomux.dev7771`.
